...
# Text box for the best unit price for budget
tbox_best_budget = tk.Text(window, width=5, height=0, state="disabled")
...
tbox_best_budget.place(x=130, y=340)
btn_best_budget.place(x=100, y=300)
